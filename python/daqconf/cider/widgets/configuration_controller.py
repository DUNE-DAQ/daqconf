...
class ConfigurationController(Static):    
    ...
    def can_be_disabled(self)->bool:
        ...
        if self._current_selected_object not in self._handler.configuration_handler.get_all_conf_classes()['ResourceBase']:
            self._logger.write_error(f"Cannot disable {self.generate_rich_string(self._current_selected_object)} must inherit from [red]ResourceBase[/red]!")
            return False
