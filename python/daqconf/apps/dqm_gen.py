...
def get_dqm_app( DATA_RATE_SLOWDOWN_FACTOR=1,
                 ...
                 DQM_RMS_PARAMS=[10, 1000],
                 DQM_STD_PARAMS=[10, 1000],
                 DQM_FOURIER_CHANNEL_PARAMS=[600, 100],
                 DQM_FOURIER_PLANE_PARAMS=[60, 1000],
                 LINKS=[],
                 HOST="localhost",
                 MODE="readout",
                 DF_RATE=10,
    ...
    modules += [DAQModule(name='dqmprocessor',
                          ...
                          conf=dqmprocessor.Conf(
                              ...
                              stdev=dqmprocessor.StandardDQM(**{'how_often' : DQM_STD_PARAMS[0], 'num_frames' : DQM_STD_PARAMS[1]}),
                              fourier=dqmprocessor.StandardDQM(**{'how_often' : DQM_FOURIER_CHANNEL_PARAMS[0], 'num_frames' : DQM_FOURIER_CHANNEL_PARAMS[1]}),
                              fourier_sum=dqmprocessor.StandardDQM(**{'how_often' : DQM_FOURIER_PLAN_PARAMS[0], 'num_frames' : DQM_FOURIER_PLAN_PARAMS[1]}),
