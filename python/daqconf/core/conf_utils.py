...
def generate_boot(
    ...
    info_svc_uri_map = {
        'cern':  "kafka://np04-srv-017.cern.ch:30092/opmon",
    ...
    if boot_conf.ers_impl == 'cern':
        use_kafka = True
        ers_settings["INFO"] =    "erstrace,throttle,lstdout,erskafka(np04-srv-017.cern.ch:30092)"
        ers_settings["WARNING"] = "erstrace,throttle,lstdout,erskafka(np04-srv-017.cern.ch:30092)"
        ers_settings["ERROR"] =   "erstrace,throttle,lstdout,erskafka(np04-srv-017.cern.ch:30092)"
        ers_settings["FATAL"] =   "erstrace,lstdout,erskafka(np04-srv-017.cern.ch:30092)"
