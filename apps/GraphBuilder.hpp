...
#ifndef DAQCONF_APPS_GRAPHBUILDER_HPP_
#define DAQCONF_APPS_GRAPHBUILDER_HPP_
...
ERS_DECLARE_ISSUE(daqconf, GeneralGraphToolError, "A graph tool error occured: " << errmsg, ((std::string)errmsg))

#endif // DAQCONF_APPS_GRAPHBUILDER_HPP_
