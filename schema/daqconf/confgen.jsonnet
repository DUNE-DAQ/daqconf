...
local cs = {
  ...
  tam_algorithms:  s.sequence( "TriggerAlgorithms", self.string, doc="List of TAMaker algorithms to run concurrently."),
  tam_configs:     s.sequence( "TriggerAlgorithmsConfigs", self.trigger_algo_config, doc="List of TAMaker algorithm configs."),
  ...
  trigger: s.record("trigger",[
    ...
    s.field( "trigger_activity_plugin", self.tam_algorithms, default=['TriggerActivityMakerPrescalePlugin'], doc="Trigger activity algorithm plugin(s)"),
    s.field( "trigger_activity_config", self.tam_configs, default=[self.trigger_algo_config], doc="Trigger activity algorithm config (string containing python dictionary)"),
    s.field( "trigger_candidate_plugin", self.tam_algorithms, default=['TriggerCandidateMakerPrescalePlugin'], doc="Trigger candidate algorithm plugin"),
    s.field( "trigger_candidate_config", self.tam_configs, default=[self.trigger_algo_config], doc="Trigger candidate algorithm config (string containing python dictionary)"),
