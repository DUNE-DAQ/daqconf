...
local cs = {
    ...
    timing: s.record("timing", [
        ...
        # trigger options
         ...
         s.field( "trigger_activity_config", self.trigger_algo_config, doc="Trigger activity algorithm config (string containing python dictionary)"),
         ...
         s.field( "trigger_candidate_config", self.trigger_algo_config, doc="Trigger candidate algorithm config (string containing python dictionary)"),
